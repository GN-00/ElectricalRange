...
namespace ProjectsNow.Estimator.References
{
    public class Group : ModelBase
    {
        ...
        {
            get => new(new Uri($"/Estimator/Images/GroupIcons/{Image}.png", UriKind.Relative));
        }
        ...
        public void Selecting()
        {
            ...
            string query;
            int groupNumber = 1;
            using SqlConnection connection = new(AppData.ConnectionString);
