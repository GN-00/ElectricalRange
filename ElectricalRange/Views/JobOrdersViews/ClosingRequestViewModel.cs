...
namespace ProjectsNow.Views.JobOrdersViews
{
    public class ClosingRequestViewModel : ViewModelBase
    {
        ...
        public ClosingRequestViewModel(ClosingRequest request, ObservableCollection<Panel> panels, ObservableCollection<JPanel> orderPanels)
        {
            RequestData = request;
        ...
        private bool DataFilter(object panel)
        {
            ...
            if (((JPanel)panel).ReadyToCloseQty == 0)
                return false;
