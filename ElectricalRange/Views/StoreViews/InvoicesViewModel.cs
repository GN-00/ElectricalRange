...
using ProjectsNow.Windows.StoreWindows.InvoicesWindows;
...
namespace ProjectsNow.Views.StoreViews
{
    internal class InvoicesViewModel : ViewModelBase
    {
        ...
        public InvoicesViewModel(JobOrder jobOrder, IView view)
        {
            ViewData = view;
        ...
        private void PurchaseOrders(SupplierInvoice invoice)
        {
            ...
            {
                Windows.StoreWindows.InvoicesWindows.PurshaseOrderItems.ItemsWindow itemsWindow =
                         new(invoice);
        ...
        private void ReturnItems(SupplierInvoice invoice)
        {
            ...
            {
                Windows.StoreWindows.ReturnToSuppliersWindows.ReturnToSupplierWindow returnToSupplierWindow =
                                    new(invoice);
        ...
        private void Print(SupplierInvoice invoice)
        {
            Printing.PrintingHelper.PrintInternalInvoice(invoice.ID, ViewData);
        }
        private bool CanAccessPrint(SupplierInvoice invoice)
        {
            if (invoice == null)
                return false;
        ...
        {
            Printing.PrintingHelper.PrintReturnInvoice(item.ReturnInvoiceID.Value, ViewData);
        }
        ...
        {
            Windows.StoreWindows.TransferWindows.TransferWindow transferWindow = new()
            {
                UserData = UserData,
                JobOrderData = JobOrderData,
