...
{
    public class SuppliersInvoicesViewModel : ViewModelBase
    {
        ...
        public SuppliersInvoicesViewModel(JobOrder order, IView view)
        {
            ViewData = view;
            OrderData = order;
        ...
        private void CreateCollectionView()
        {
            ...
            ItemsCollection.GroupDescriptions.Add(new PropertyGroupDescription("SupplierName"));
