...
{
    public class SupplierStatementViewModel : ViewModelBase
    {
        ...
        public SupplierStatementViewModel(SupplierAccount account, IView View)
        {
            ViewData = View;
        ...
        private void Print()
        {
            ...
            if (pages != 0)
            {
                ...
                {
                    Printing.Finance.SupplierStatement statement = new()
                    {
                ...
                Printing.Print.PrintPreview(elements, $"Statement-{SupplierData.Name}", ViewData);
            }
            else
            {
